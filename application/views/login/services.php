									...
									<div class="flex-row">
										...
										<div class="flex-col-md-4">
											<div class="info-obj img-t g30 pd-tiny medium align-c typo-light mr-0 animated s008 fadeInUp" data-animin="fadeInUp|0.6" data-animout="fadeOut|0.1" data-bgcolor="rgba(255,255,255,0.04)" style="background-color: rgba(255, 255, 255, 0.04); animation-delay: 0.6s;">
												<div class="img txt-default"><span class="iconwrp"><i class="pe-7s-graph1"></i></span></div>
												<div class="info">
													<a href="#">
														<h3>CMS</h3>
														<p class="mr-0 op-08 f-2 bold-1">Lorem ipsum dolor sit ametconsetetur sadipscing nonumy eirmod</p>
													</a>
												</div>
											</div>
										</div>
										...
										<div class="flex-col-md-4">
											<div class="info-obj img-t g30 pd-tiny medium align-c typo-light mr-0 animated s008 fadeInUp" data-animin="fadeInUp|0.7" data-animout="fadeOut|0.1" data-bgcolor="rgba(255,255,255,0.06)" style="background-color: rgba(255, 255, 255, 0.06); animation-delay: 0.7s;">
												<div class="img txt-default"><span class="iconwrp"><i class="pe-7s-monitor"></i></span></div>
												<div class="info">
													<a href="#">
														<h3>CERTIFICATION</h3>
														<p class="mr-0 op-08 f-2 bold-1">Lorem ipsum dolor sit ametconsetetur sadipscing nonumy eirmod</p>
										...
										<div class="flex-col-md-4">
											<div class="info-obj img-t g30 pd-tiny medium align-c typo-light mr-0 animated s008 fadeInUp" data-animin="fadeInUp|0.4" data-animout="fadeOut|0.1" data-bgcolor="rgba(255,255,255,0.06)" style="background-color: rgba(255, 255, 255, 0.06); animation-delay: 0.4s;">
												<div class="img txt-default"><span class="iconwrp"><i class="pe-7s-medal"></i></span></div>
												<div class="info">
													<a href="#">
														<h3>LUMINA</h3>
														<p class="mr-0 op-08 f-2 bold-1">Lorem ipsum dolor sit ametconsetetur sadipscing nonumy eirmod</p>
